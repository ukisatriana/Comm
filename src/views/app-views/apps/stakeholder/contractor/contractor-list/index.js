...
const ContractorList = () => {
	...
	const addContractor = () => {
		navigate(`/app/apps/stakeholder/contractor/contractor-add`)
	}
	
	const viewDetails = row => {
		navigate(`/app/apps/stakeholder/contractor/contractor-edit/${row.id}`)
	}
	...
	return (
		<Card>
			<Flex alignItems="center" justifyContent="space-between" mobileFlex={false}>
				...
				<div>
					<Button onClick={addContractor} type="primary" icon={<PlusCircleOutlined />} block>Add Contractor</Button>
				</div>
			</Flex>
