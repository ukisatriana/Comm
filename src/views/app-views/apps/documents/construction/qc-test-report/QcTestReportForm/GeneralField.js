...
const GeneralField = ({ handleFileUpload }) => {
	...
	const handleUploadChange = async ({ file }) => {
		...
		const storageRef = ref(storage, `documents/construction/qcTestDocs/${file.name}`);
	...
	<Row gutter={16}>
		<Col xs={24} sm={24} md={17}>
			<Card title="Basic Info">
				<Form.Item name="qcTestReportDocsName" label="Qc Test Report Name" >
					<Input placeholder="Qc Test Report Name" />
				</Form.Item>
