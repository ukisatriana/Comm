...
const QcTestList = () => {
	...
	const addQcTestReport = () => {
		navigate(`/app/apps/documents/construction/qc-test-report/qc-test-report-add`)
	}
	...
	return (
		<Card>
			<Flex alignItems="center" justifyContent="space-between" mobileFlex={false}>
				...
				<div>
					<Button onClick={addQcTestReport} type="primary" icon={<PlusCircleOutlined />} block>Add Document</Button>
				</div>
			</Flex>
